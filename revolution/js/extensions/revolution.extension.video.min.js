...
! function(e) {
    ...
    jQuery.extend(!0, a, {
        ...
        resetVideo: function(e, o, d) {
            ...
            switch (r.videotype) {
                case "youtube":
                    ...
                    try {
                        if ("on" == r.forcerewind) {
                            p = t(e.data("videostartat")), 1 === r.bgvideo || e.find(".tp-videoposter").length;
                            void 0 != r.player && (p = -1 == p ? 0 : p, r.player.seekTo(p), r.player.pauseVideo())
                        }
                    } catch (e) {}
                    0 == e.find(".tp-videoposter").length && 1 !== r.bgvideo && !0 !== d && punchgs.TweenLite.to(e.find("iframe"), .3, {
                        autoAlpha: 1,
                        display: "block",
                    ...
                    break;
                case "vimeo":
                    var n = e.data("vimeoplayer");
                    try {
                        if ("on" == r.forcerewind) {
                            p = t(r.videostartat), 1 === r.bgvideo || e.find(".tp-videoposter").length;
                            p = -1 == p ? 0 : p, n.seekTo(p), n.pause()
                        }
                    } catch (e) {}
                    0 == e.find(".tp-videoposter").length && 1 !== r.bgvideo && !0 !== d && punchgs.TweenLite.to(e.find("iframe"), .3, {
                        autoAlpha: 1,
                ...
                case "html5":
                    ...
                    var s = "html5" == r.audio ? "audio" : "video",
                        l = e.find(s),
                        u = l[0];
                    if (punchgs.TweenLite.to(l, .3, {
                            ...
                            display: "block",
                            ease: punchgs.Power3.easeInOut
                        }), "on" == r.forcerewind && !e.hasClass("videoisplaying")) try {
                        var p = t(r.videostartat);
                        u.currentTime = -1 == p ? 0 : p
                    } catch (e) {}("mute" == r.volume || a.lastToggleState(e.videomutetoggledby) || !0 === o.globalmute) && (u.muted = !0)
            }
        },
        ...
        playVideo: function(e, i) {
            ...
            switch (o.videotype) {
                case "youtube":
                    if (0 == e.find("iframe").length) e.append(e.data("videomarkup")), n(e, i, !0);
                    else if (void 0 != o.player.playVideo) {
                        var r = t(e.data("videostartat")),
                            s = o.player.getCurrentTime();
                        1 == e.data("nextslideatend-triggered") && (s = -1, e.data("nextslideatend-triggered", 0)), -1 != r && r > s && o.player.seekTo(r), !0 !== o.youtubepausecalled && o.player.playVideo()
                    } else e.data("videoplaywait", setTimeout(function() {
                        !0 !== o.youtubepausecalled && a.playVideo(e, i)
                    }, 50));
                    break;
                case "vimeo":
                    if (0 == e.find("iframe").length) e.removeData("vimeoplayer"), e.append(e.data("videomarkup")), n(e, i, !0);
                    else if (e.hasClass("rs-apiready")) {
                        var l, u = e.find("iframe").attr("id");
                        e.data("vimeoplayer") ? l = e.data("vimeoplayer") : (l = new Vimeo.Player(u), e.data("vimeoplayer", l)), setTimeout(function() {
                            l.play();
                            var a = t(e.data("videostartat")),
                                i = e.data("currenttime");
                            1 == e.data("nextslideatend-triggered") && (i = -1, e.data("nextslideatend-triggered", 0)), -1 != a && a > i && l.seekTo(a)
                        }, 510)
                    } else e.data("videoplaywait", setTimeout(function() {
                ...
                case "html5":
                    ...
                    if (1 != v.parent().data("metaloaded")) d(c, "loadedmetadata", function(e) {
                        ...
                        var r = t(e.data("videostartat")),
                            s = c.currentTime;
                        1 == e.data("nextslideatend-triggered") && (s = -1, e.data("nextslideatend-triggered", 0)), -1 != r && r > s && (c.currentTime = r)
                    }
            }
        },
        ...
        prepareCoveredVideo: function(e, t, i) {
            var o = i.find("iframe, video"),
                ...
                u = s / l * 100,
                p = l / s * 100;
            s > l ? punchgs.TweenLite.to(o, .001, {
                height: u + "%",
                width: "100%",
                top: -(u - 100) / 2 + "%",
                left: "0px",
                position: "absolute"
            }) : punchgs.TweenLite.to(o, .001, {
                width: p + "%",
                height: "100%",
                left: -(p - 100) / 2 + "%",
                top: "0px",
                position: "absolute"
            }), o.hasClass("resizelistener") || (o.addClass("resizelistener"), jQuery(window).resize(function() {
                clearTimeout(o.data("resizelistener")), o.data("resizelistener", setTimeout(function() {
        ...
        manageVideoLayer: function(e, r, s, l) {
            if ("stop" === a.compare_version(o).check) return !1;
            var p = e.data(),
                v = p.videoattributes,
                c = p.ytid,
                g = p.vimeoid,
                m = "auto" === p.videopreload || "canplay" === p.videopreload || "canplaythrough" === p.videopreload || "progress" === p.videopreload ? "auto" : p.videopreload,
                y = p.videomp4,
                f = p.videowebm,
                h = p.videoogv,
                b = p.allowfullscreenvideo,
                w = p.videocontrols,
                T = "http",
                k = "loop" == p.videoloop ? "loop" : "loopandnoslidestop" == p.videoloop ? "loop" : "",
                x = void 0 != y || void 0 != f ? "html5" : void 0 != c && String(c).length > 1 ? "youtube" : void 0 != g && String(g).length > 1 ? "vimeo" : "none",
                V = "html5" == p.audio ? "audio" : "video",
                L = "html5" == x && 0 == e.find(V).length ? "html5" : "youtube" == x && 0 == e.find("iframe").length ? "youtube" : "vimeo" == x && 0 == e.find("iframe").length ? "vimeo" : "none";
            switch (k = !0 === p.nextslideatend ? "" : k, p.videotype = x, L) {
                case "html5":
                    "controls" != w && (w = "");
                    V = "video";
                    "html5" == p.audio && (V = "audio", e.addClass("tp-audio-html5"));
                    var P = "";
                    "video" === V && (a.is_mobile() || a.isSafari11()) && ("on" === p.autoplay || "true" === p.autoplay || !0 === p.autoplay ? P = "muted playsinline autoplay" : 1 != p.videoinline && "true" !== p.videoinline && 1 !== p.videoinline || (P += " playsinline"));
                    var C = "<" + V + " " + P + ' style="object-fit:cover;background-size:cover;visible:hidden;width:100%; height:100%" class="" ' + k + ' preload="' + m + '">';
                    "auto" == m && (r.mediapreload = !0), void 0 != f && "firefox" == a.get_browser().toLowerCase() && (C = C + '<source src="' + f + '" type="video/webm" />'), void 0 != y && (C = C + '<source src="' + y + '" type="video/mp4" />'), void 0 != h && (C = C + '<source src="' + h + '" type="video/ogg" />'), C = C + "</" + V + ">";
                    var I = "";
                    "true" !== b && !0 !== b || (I = '<div class="tp-video-button-wrap"><button  type="button" class="tp-video-button tp-vid-full-screen">Full-Screen</button></div>'), "controls" == w && (C = C + '<div class="tp-video-controls"><div class="tp-video-button-wrap"><button type="button" class="tp-video-button tp-vid-play-pause">Play</button></div><div class="tp-video-seek-bar-wrap"><input  type="range" class="tp-seek-bar" value="0"></div><div class="tp-video-button-wrap"><button  type="button" class="tp-video-button tp-vid-mute">Mute</button></div><div class="tp-video-vol-bar-wrap"><input  type="range" class="tp-volume-bar" min="0" max="1" step="0.1" value="1"></div>' + I + "</div>"), e.data("videomarkup", C), e.append(C), (i && 1 == e.data("disablevideoonmobile") || a.isIE(8)) && e.find(V).remove(), e.find(V).each(function(t) {
                        var i = this,
                            o = jQuery(this);
                        o.parent().hasClass("html5vid") || o.wrap('<div class="html5vid" style="position:relative;top:0px;left:0px;width:100%;height:100%; overflow:hidden;"></div>'), 1 != o.parent().data("metaloaded") && d(i, "loadedmetadata", function(e) {
                            u(e, r), a.resetVideo(e, r)
                        }(e))
                    });
                    break;
                case "youtube":
                    T = "https", "none" == w && -1 == (v = v.replace("controls=1", "controls=0")).toLowerCase().indexOf("controls") && (v += "&controls=0"), (!0 === p.videoinline || "true" === p.videoinline || 1 === p.videoinline || e.hasClass("rs-background-video-layer")) && (v += "&playsinline=1");
            ...
            if (void 0 != p.videoposter && p.videoposter.length > 2 && !Q) 0 == e.find(".tp-videoposter").length && e.append('<div class="tp-videoposter noSwipe" style="cursor:pointer; position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:3;background-image:url(' + p.videoposter + '); background-size:cover;background-position:center center;"></div>'), 0 == e.find("iframe").length && e.find(".tp-videoposter").click(function() {
                ...
                0 != e.find("iframe").length || "youtube" != x && "vimeo" != x || (e.removeData("vimeoplayer"), e.append(e.data("videomarkup")), n(e, r, !1))
            }
    ...
    var d = function(e, t, a) {
        ...
        n = function(e, o, d) {
            ...
            if (g = "loop" == g || "loopandnoslidestop" == g, 1 == e.data("forcecover") && (e.removeClass("fullscreenvideo").addClass("coverscreenvideo"), void 0 != (y = e.data("aspectratio")) && y.split(":").length > 1 && a.prepareCoveredVideo(y, o, e)), 1 == e.data("bgvideo")) {
                var y = e.data("aspectratio");
                void 0 != y && y.split(":").length > 1 && a.prepareCoveredVideo(y, o, e)
            }
            if (u.attr("id", c), d && e.data("startvideonow", !0), 1 !== e.data("videolistenerexist")) switch (n.videotype) {
                case "youtube":
                    P = new YT.Player(c, {
                        events: {
                            onStateChange: function(i) {
                                var d = e.closest(".tp-simpleresponsive"),
                                    u = (n.videorate, e.data("videostart"), l());
                                if (i.data == YT.PlayerState.PLAYING) punchgs.TweenLite.to(e.find(".tp-videoposter"), .3, {
                                    ...
                                    display: "block",
                                    ease: punchgs.Power3.easeInOut
                                }), "mute" == e.data("volume") || a.lastToggleState(e.data("videomutetoggledby")) || !0 === o.globalmute ? P.mute() : (P.unMute(), P.setVolume(parseInt(e.data("volume"), 0) || 75)), o.videoplaying = !0, p(e, o), m ? o.c.trigger("stoptimer") : o.videoplaying = !1, o.c.trigger("revolution.slide.onvideoplay", r(P, "youtube", e.data())), a.toggleState(n.videotoggledby);
                                else {
                                    if (0 == i.data && g) {
                                        var c = t(e.data("videostartat")); - 1 != c && P.seekTo(c), P.playVideo(), a.toggleState(n.videotoggledby)
                                    }
                                    u || 0 != i.data && 2 != i.data || !("on" == e.data("showcoveronpause") && e.find(".tp-videoposter").length > 0 || 1 === e.data("bgvideo") && e.find(".rs-fullvideo-cover").length > 0) || (1 === e.data("bgvideo") ? punchgs.TweenLite.to(e.find(".rs-fullvideo-cover"), .1, {
                                        autoAlpha: 1,
                                        force3D: "auto",
                                        ease: punchgs.Power3.easeInOut
                            ...
                            onReady: function(o) {
                                ...
                                if (r || a.isSafari11()) {
                                    var l = s && "off" !== e.data("autoplay");
                                    (e.hasClass("rs-background-video-layer") || l) && (r && s || (d = !0, P.setVolume(0), e.data("volume", "mute"), P.mute(), clearTimeout(e.data("mobilevideotimr")), e.data("mobilevideotimr", setTimeout(function() {
                                        P.playVideo()
                                    }, 500))))
                                }
                                d || "mute" != e.data("volume") || (P.setVolume(0), P.mute());
                                var u = n.videorate;
                                e.data("videostart");
                                if (e.addClass("rs-apiready"), void 0 != u && o.target.setPlaybackRate(parseFloat(u)), e.find(".tp-videoposter").unbind("click"), e.find(".tp-videoposter").click(function() {
                                    ...
                                    n.player.playVideo();
                                    var p = t(e.data("videostartat")); - 1 != p && n.player.seekTo(p)
                                }
                    ...
                    break;
                case "vimeo":
                    for (var f, h = u.attr("src"), b = {}, w = h, T = /([^&=]+)=([^&]*)/g; f = T.exec(w);) b[decodeURIComponent(f[1])] = decodeURIComponent(f[2]);
                    h = void 0 != b.player_id ? h.replace(b.player_id, c) : h + "&player_id=" + c;
                    try {
                    ...
                    x && V && (h += "&background=1"), u.attr("src", h);
                    var L, P = e.find("iframe")[0];
                    jQuery("#" + c);
                    if (e.data("vimeoplayer") ? L = e.data("vimeoplayer") : (L = new Vimeo.Player(c), e.data("vimeoplayer", L)), x) {
                        var C;
                        if (V) C = !0;
                        else {
                            var I = e.data("autoplay");
                            "on" !== I && "true" !== I && !0 !== I || (k && e.data("autoplay", !1), C = !0)
                        }
                        C && (L.setVolume(0), e.data("volume", "mute"))
                    }
                    e.addClass("rs-apiready"), L.on("play", function(t) {
                        e.data("nextslidecalled", 0), punchgs.TweenLite.to(e.find(".tp-videoposter"), .3, {
                            ...
                            display: "block",
                            ease: punchgs.Power3.easeInOut
                        }), o.c.trigger("revolution.slide.onvideoplay", r(L, "vimeo", e.data())), o.videoplaying = !0, p(e, o), m ? o.c.trigger("stoptimer") : o.videoplaying = !1, "mute" == e.data("volume") || a.lastToggleState(e.data("videomutetoggledby")) || !0 === o.globalmute ? L.setVolume(0) : L.setVolume(parseInt(e.data("volume"), 0) / 100 || .75), a.toggleState(n.videotoggledby)
                    }), L.on("playProgress", function(a) {
                        var i = t(e.data("videoendat"));
                        if (e.data("currenttime", a.seconds), 0 != i && Math.abs(i - a.seconds) < .3 && i > a.seconds && 1 != e.data("nextslidecalled"))
                            if (g) {
                                L.play();
                                var d = t(e.data("videostartat")); - 1 != d && L.seekTo(d)
                            } else 1 == e.data("nextslideatend") && (e.data("nextslideatend-triggered", 1), e.data("nextslidecalled", 1), o.c.revnext()), L.pause()
                    }), L.on("finish", function(t) {
                        v(e, o), o.videoplaying = !1, o.c.trigger("starttimer"), o.c.trigger("revolution.slide.onvideostop", r(L, "vimeo", e.data())), 1 == e.data("nextslideatend") && (e.data("nextslideatend-triggered", 1), o.c.revnext()), void 0 != o.currentLayerVideoIsPlaying && o.currentLayerVideoIsPlaying.attr("id") != e.attr("id") || a.unToggleState(n.videotoggledby)
                        ...
                        ("on" == e.data("showcoveronpause") && e.find(".tp-videoposter").length > 0 || 1 === e.data("bgvideo") && e.find(".rs-fullvideo-cover").length > 0) && (1 === e.data("bgvideo") ? punchgs.TweenLite.to(e.find(".rs-fullvideo-cover"), .1, {
                            ...
                            autoAlpha: 0,
                            ease: punchgs.Power3.easeInOut
                        })), o.videoplaying = !1, o.tonpause = !1, v(e, o), o.c.trigger("starttimer"), o.c.trigger("revolution.slide.onvideostop", r(L, "vimeo", e.data())), void 0 != o.currentLayerVideoIsPlaying && o.currentLayerVideoIsPlaying.attr("id") != e.attr("id") || a.unToggleState(n.videotoggledby)
                    }), e.find(".tp-videoposter").unbind("click"), e.find(".tp-videoposter").click(function() {
                        if (!i) return L.play(), !1
                    }), e.data("startvideonow") && (L.play(), -1 != (_ = t(e.data("videostartat"))) && L.seekTo(_)), e.data("videolistenerexist", 1), V && L.play()
            } else {
                var _ = t(e.data("videostartat"));
                switch (n.videotype) {
                    case "youtube":
                        d && (n.player.playVideo(), -1 != _ && n.player.seekTo());
                        break;
                    case "vimeo":
        ...
        u = function(e, o, n) {
            if (i && 1 == e.data("disablevideoonmobile")) return !1;
            var u = e.data(),
                c = "html5" == u.audio ? "audio" : "video",
                g = e.find(c),
                m = g[0],
                y = g.parent(),
                f = u.videoloop,
                h = "loopandnoslidestop" != f;
            if (f = "loop" == f || "loopandnoslidestop" == f, y.data("metaloaded", 1), 1 != e.data("bgvideo") || "none" !== u.videoloop && !1 !== u.videoloop || (h = !1), void 0 == g.attr("control") && (0 != e.find(".tp-video-play-button").length || i || e.append('<div class="tp-video-play-button"><i class="revicon-right-dir"></i><span class="tp-revstop">&nbsp;</span></div>'), e.find("video, .tp-poster, .tp-video-play-button").click(function() {
                ...
                if (1 == e.data("forcecover") || 1 == e.data("bgvideo")) {
                    ...
                    a.setSize(o), a.prepareCoveredVideo(b, o, e)
            ...
            void 0 != w && d(w, "click", function() {
                ...
                p(e, o), h && "audio" != i ? (o.videoplaying = !0, o.c.trigger("stoptimer"), o.c.trigger("revolution.slide.onvideoplay", r(m, "html5", u))) : (o.videoplaying = !1, "audio" != i && o.c.trigger("starttimer"), o.c.trigger("revolution.slide.onvideostop", r(m, "html5", u))), punchgs.TweenLite.to(e.find(".tp-videoposter"), .3, {
                    autoAlpha: 0,
                    force3D: "auto",
                    ease: punchgs.Power3.easeInOut
                ...
                void 0 != d && (d.innerHTML = "Pause"), void 0 != n && m.muted && (n.innerHTML = "Unmute"), a.toggleState(u.videotoggledby)
            }), d(m, "pause", function(t) {
                var i = "html5" == u.audio ? "audio" : "video";
                !l() && e.find(".tp-videoposter").length > 0 && "on" == e.data("showcoveronpause") && !e.hasClass("seekbardragged") && (punchgs.TweenLite.to(e.find(".tp-videoposter"), .3, {
                    autoAlpha: 1,
                    force3D: "auto",
                    ease: punchgs.Power3.easeInOut
                }), punchgs.TweenLite.to(e.find(i), .3, {
                    autoAlpha: 0,
                    ease: punchgs.Power3.easeInOut
                })), e.removeClass("videoisplaying"), o.videoplaying = !1, v(e, o), "audio" != i && o.c.trigger("starttimer"), o.c.trigger("revolution.slide.onvideostop", r(m, "html5", e.data()));
                var d = e.find(".tp-vid-play-pause")[0];
                void 0 != d && (d.innerHTML = "Play"), void 0 != o.currentLayerVideoIsPlaying && o.currentLayerVideoIsPlaying.attr("id") != e.attr("id") || a.unToggleState(u.videotoggledby)
            }), d(m, "ended", function() {
                s(), v(e, o), o.videoplaying = !1, v(e, o), "audio" != c && o.c.trigger("starttimer"), o.c.trigger("revolution.slide.onvideostop", r(m, "html5", e.data())), !0 === e.data("nextslideatend") && m.currentTime > 0 && (1 == !o.just_called_nextslide_at_htmltimer && (e.data("nextslideatend-triggered", 1), o.c.revnext(), o.just_called_nextslide_at_htmltimer = !0), setTimeout(function() {
                    o.just_called_nextslide_at_htmltimer = !1
